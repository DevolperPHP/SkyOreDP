...
class SkyOreDP extends PluginBase implements Listener {
        ...
        if(in_array($level,$this->arenas))
        {
            ...
            if($block == 73){
                switch (mt_rand(1,10)){
                    ...
                    case 4:
                        $event->setDrops(array(Item::get(331, 0, 0)));
                        $player->getInventory()->addItem(Item::get(79, 0, 1));
                    ...
                    case 9:
                        $event->setDrops(array(Item::get(331, 0, 0)));
                        $player->getInventory()->addItem(Item::get(389, 0, 1));

                        break;

                    case 10:
                        $event->setDrops(array(Item::get(331, 0, 0)));
                        $player->getInventory()->addItem(Item::get(397, 0, 1));
                }
            }
            ...
            if($block == 16){
                switch (mt_rand(1,8)){
                    ...
                    case 7:
                        $event->setDrops(array(Item::get(263, 0, 1)));
                        $player->getInventory()->addItem(Item::get(349, 0, 30));

                        break;

                    case 8:
                        $event->setDrops(array(Item::get(263, 0, 1)));
                        $player->getInventory()->addItem(Item::get(350, 0, 10));
                }
            }
        }
    }
    ...
    public function setkit($p)
    {
        ...
        if($kit=="Player")
        {
            ...
            $p->setNameTag(TE::GRAY."[".TE::GREEN."Player".TE::GRAY."]".TE::AQUA.$p->getName());
        }
        elseif($kit=="Pro"){
            ...
            $p->setNameTag(TE::GRAY."[".TE::GREEN."PRO".TE::GRAY."]".TE::AQUA.$p->getName());
        }
        elseif($kit=="MVP+")
        {
            ...
            $p->setNameTag(TE::GRAY."[".TE::GOLD."MVP+".TE::GREEN."+".TE::GRAY."]".TE::AQUA.$p->getName());
        }
